...
2. Open `.env` in a text editor and configure the variables according to your needs. See [Environment Variables](configuration/environment-variables.md) for detailed descriptions of all available options.
...
2. Edit `.env` and configure variables as described in [Environment Variables](configuration/environment-variables.md).
...
See the [Configuration](configuration/environment-variables.md) section for advanced configuration options.
